...
<template>
  <section>
    <div class="services-content">
      <h2 class="services-content__h2 text-transform-uppercase t-end">
        SZOLGÁLTATÁSAINK
      </h2>
      <div class="grid-4">
        <div
        ...
        >
          <NuxtImg
            ...
            height="100%"
          />
          <h3 class="services-content__img-text-box__h3 text-center">
            CSAPÁGYAK
          </h3>
          <p class="services-content__img-text-box__p">
