...
const _sfc_main = {
  __name: "letoltheto-anyagok",
  __ssrInlineRender: true,
  setup(__props) {
    useHead({
      title: "Let\xF6lthet\u0151 anyagok"
    });
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "supage-content position-relative" }, _attrs))}><h2 class="supage-content__h2 text-color">Let\xF6lthet\u0151 anyagok</h2><p>Felt\xF6l\xE9s alatt...</p></div>`);
    };
  }
};
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/letoltheto-anyagok.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=letoltheto-anyagok-Bfpsd4UM.mjs.map
