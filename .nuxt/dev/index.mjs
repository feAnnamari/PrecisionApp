...
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, hasProtocol, withHttps, withoutProtocol, withLeadingSlash, withBase, withoutTrailingSlash } from 'file:///Applications/XAMPP/xamppfiles/htdocs/PrecisionApp/node_modules/ufo/dist/index.mjs';
...
import { consola } from 'file:///Applications/XAMPP/xamppfiles/htdocs/PrecisionApp/node_modules/consola/dist/index.mjs';
import devalue from 'file:///Applications/XAMPP/xamppfiles/htdocs/PrecisionApp/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { getContext } from 'file:///Applications/XAMPP/xamppfiles/htdocs/PrecisionApp/node_modules/unctx/dist/index.mjs';
import { toValue, version, unref } from 'file:///Applications/XAMPP/xamppfiles/htdocs/PrecisionApp/node_modules/vue/index.mjs';
...
import { isAbsolute } from 'file:///Applications/XAMPP/xamppfiles/htdocs/PrecisionApp/node_modules/pathe/dist/index.mjs';
...
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Applications/XAMPP/xamppfiles/htdocs/PrecisionApp/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _tOxeZvG0GK = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "/Applications/XAMPP/xamppfiles/htdocs/PrecisionApp";

const asyncContext = getContext("nuxt-dev", { asyncContext: true, AsyncLocalStorage });
const _MIZqyQ1dCs = (nitroApp) => {
...
const _082Xhi = defineEventHandler(async (e) => {
  const siteConfig = useSiteConfig(e);
  const nitroOrigin = useNitroOrigin(e);
  const runtimeConfig = useRuntimeConfig(e);
...
const _6F7XIu = defineEventHandler(async (e) => {
...
const _lazy_SIBl6n = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_SIBl6n, lazy: true, middleware: false, method: undefined },
  { route: '', handler: _4tVCXI, lazy: false, middleware: true, method: undefined },
  { route: '/__site-config__/debug.json', handler: _082Xhi, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/debug.json', handler: _6F7XIu, lazy: false, middleware: false, method: undefined },
...
const getClientManifest = () => import('file:///Applications/XAMPP/xamppfiles/htdocs/PrecisionApp/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///Applications/XAMPP/xamppfiles/htdocs/PrecisionApp/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
